...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br w-full from-blue-50 via-green-50 to-blue-100 flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-10 -left-10 size-72 bg-gradient-to-r from-blue-200 to-green-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
        <div className="absolute -top-10 -right-10 size-72 bg-gradient-to-r from-green-200 to-blue-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-8 left-20 size-72 bg-gradient-to-r from-blue-300 to-green-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
      </div>
      <div className="flex max-w-7xl w-full relative z-10">
        <div className="hidden lg:flex lg:w-2/5 bg-gradient-to-br from-blue-600 to-green-600 rounded-l-3xl p-12 text-white flex-col justify-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl font-bold mb-6 leading-tight">
              Commencez votre
              <span className="text-green-300"> voyage </span>
              d&apos;apprentissage
            </h2>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-white border-opacity-20">
              <div className="text-center">
                ...
                <div className="text-xs text-blue-100">Cours</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-300">50k+</div>
                <div className="text-xs text-blue-100">Étudiants</div>
              </div>
              <div className="text-center">
        ...
        <div className="w-full lg:w-3/5 bg-white lg:rounded-r-3xl shadow-2xl p-8 lg:p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className={`w-full bg-gradient-to-r from-blue-600 to-green-600 text-white py-4 px-6 rounded-xl font-semibold text-lg transition-all duration-200 transform hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                loading ||
                !name ||
                !email ||
                !telephone ||
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              ...
              <a
                href="/login"
                className="bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent font-semibold hover:underline transition-colors"
              >
                Se connecter
              </a>
            </p>
